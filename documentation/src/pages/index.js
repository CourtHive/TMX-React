...
const features = [
  {
    ...
    description: (
      <>
        CourtHive/TMX is a React based Tournament Management platform based on the ITF&apos;s{' '}
        <a href="https://itftennis.atlassian.net/wiki/spaces/TODS/overview">Tennis Open Data Standards</a>.
      </>
    )
  },
  {
    ...
    imageLink: 'https://github.com/CourtHive/TMX',
    description: (
      <>
...
export default function Home() {
  ...
  return (
    <Layout title={`${siteConfig.title}`} description="Open Source Tournament Management">

...
export const env = {
  ...
  template: 'tmx',
  embedded: false,
  visibleTabs: [TAB_TOURNAMENT, TAB_PLAYERS, TAB_EVENTS, TAB_LOCATIONS, TAB_SCHEDULE, TAB_MATCHUPS, TAB_SETTINGS],
  enabledComponents: [COMPONENT_SPLASH, COMPONENT_CALENDAR, COMPONENT_TOURNAMENT],
  enabledPDFs: [TAB_PLAYERS, TAB_EVENTS, TAB_SCHEDULE, TAB_MATCHUPS],

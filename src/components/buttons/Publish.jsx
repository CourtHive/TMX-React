...
import { TAB_TOURNAMENT, TAB_PARTICIPANTS, TAB_EVENTS, TAB_SCHEDULE } from '../../stores/tmx/types/tabs';
...
function contextPublishState({ /*tournament, selectedDraw,*/ tab }) {
  ...
  const publishState = (published && up_to_date) || published;
...
export const PublishButton = () => {
  ...
  const publishAction = () => {
    context.ee.emit('contextPublish', { tabContext, pubAction });
  };
  const Publish = () => (

...
export function matchUpFormats() {
  ...
  const formats = [
    ...
    { key: 'standard', name: 'Standard Advantage', format: 'SET3-S:6/TB7', desc: 'Best of 3 Sets to 6 with Advantage' },
    {
      key: 'atpd',
    ...
    { key: 'standard1', name: 'One Standard Set', format: 'SET1-S:6/TB7', desc: '1 Set to 6 Games, Tiebreak to 7' },
    // Best of 3 sets to 4
    {
      key: 'short',
    ...
    { key: 'short1', name: 'Fast 4', format: 'SET3-S:4/TB5@3', desc: 'Best of 3 Sets to 4, tiebreak to 5 at 3-3' },
    // One short set to 4, 7-point tiebreak at 4 games all
    { key: 'short2', name: 'One Short Set TB7', format: 'SET1-S:4/TB7', desc: 'One Set to 4, tiebreak to 7 at 4-4' },
    // One short set to 4, 5-point tiebreak at 3 games all
    { key: 'short3', name: 'One Short Set TB5', format: 'SET1-S:4/TB5@3', desc: 'One Set to 4, tiebreak to 5 at 3-3' },
    ...
    { key: 'pro', name: 'Pro Set', format: 'SET1-S:8/TB7', desc: 'One Set to 8 with Advantage, tiebreak at 8-8' },
    ...
    { key: 'tbsets2', name: 'Best of 3 TB10', format: 'SET3-S:TB10', desc: 'Best of 3 tiebreaks to 10' },
  ...
  const lookup = (key) => formats.reduce((p, c) => (c.key === key ? c.format : p), defaultMatchFormat);
  const sortedFormats = formats.sort((a, b) => (a.name > b.name ? 1 : a.name < b.name ? -1 : 0));
  const allowedSortedFormats = allowedMatchUpFormats?.length
    ? sortedFormats.filter((matchUpFormat) => allowedMatchUpFormats.includes(matchUpFormat.format))
    : sortedFormats;

  return { formats: allowedSortedFormats, lookup, default: defaultMatchFormat };
}

...
const formatDay = d => `${formatWeekdayLong(d.getDay())}, ${d.getDate()} ${getMonths()[d.getMonth()] } ${d.getFullYear()}`;
export const localeUtils = { formatDay, getMonths, formatMonthTitle, getFirstDayOfWeek, formatWeekdayLong, formatWeekdayShort };
